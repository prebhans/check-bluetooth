...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private int tabStripWidthThird;
	...
	public SlidingTabLayout(Context context) {
		this(context, null);
		Log.i(TAG, "SlidingTabLayout start A");
	}

	public SlidingTabLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		Log.i(TAG, "SlidingTabLayout start B");
	}

	public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		Log.i(TAG, "SlidingTabLayout start C");
		...
		tabStripWidth = getResources().getDisplayMetrics().widthPixels;

		mTabStrip = new SlidingTabStrip(context);
		addView(mTabStrip, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
		Log.i(TAG, "SlidingTabLayout tabStripWidth C" + " " + tabStripWidth);
	...
	public void setCustomTabColorizer(TabColorizer tabColorizer) {
		Log.i(TAG, "setCustomTabColorizer start");
	...
	public void setSelectedIndicatorColors(int... colors) {
		Log.i(TAG, "setSelectedIndicatorColors start");
	...
	public void setDividerColors(int... colors) {
		Log.i(TAG, "setDividerColors start");
	...
	public void setOnPageChangeListener(ViewPager.OnPageChangeListener listener) {
		Log.i(TAG, "setOnPageChangeListener start");
	...
	public void setCustomTabView(int layoutResId, int textViewId,
			int textDataId, int textPairId) {
		Log.i(TAG, "setCustomTabView start");
	...
	protected TextView createDefaultTabView(Context context) {
		Log.i(TAG, "createDefaultTabView start");
		...
		/**
		 * Calc the width for 3 tabs
		 */
		tabStripWidthThird = tabStripWidth / 3;
		if (tabStripWidthThird > 0)
			textView.setWidth(tabStripWidthThird);
		Log.i(TAG, "setViewPager tabStripWidth" + " " + tabStripWidthThird);
	...
	private void populateTabStrip() {
		Log.i(TAG, "populateTabStrip start");
	...
	protected void onAttachedToWindow() {
		...
		Log.i(TAG, "onAttachedToWindow start");
	...
	private void scrollToTab(int tabIndex, int positionOffset) {
		...
		Log.i(TAG, "scrollToTab end");
	}

	private class InternalViewPagerListener implements
			ViewPager.OnPageChangeListener {
		private static final String TAG = "InternalViewPagerListener";
		private int mScrollState;

		@Override
		public void onPageScrolled(int position, float positionOffset,
				int positionOffsetPixels) {
			//Log.i(TAG, "onPageScrolled start");
		...
		public void onPageScrollStateChanged(int state) {
			//Log.i(TAG, "onPageScrollStateChanged start");
			mScrollState = state;
		...
		public void onPageSelected(int position) {
			//Log.i(TAG, "onPageSelected start");
	...
	private class TabClickListener implements View.OnClickListener {
		private static final String TAG = "TabClickListener";
		...
		public void onClick(View v) {
			...
			for (int i = 0; i < mTabStrip.getChildCount(); i++) {
				if (v == mTabStrip.getChildAt(i)) {
					if (mViewPager != null) mViewPager.setCurrentItem(i, true);
					Log.i(TAG, "onClick start" + " " + i);
					return;
				}
			}
		}
